...
static void event_handler_cb_power_topology_menu_power_topology_menu(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        ...
        lv_group_add_obj(groups.PCC_topo_select_group, objects.obj4);
        // group: pcc_simple_pwm_mode
        lv_group_remove_all_objs(groups.pcc_simple_pwm_mode);
        // group: param_selector
        lv_group_remove_all_objs(groups.param_selector);
...
static void event_handler_cb_power_topology_menu_obj1(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
...
static void event_handler_cb_power_topology_menu_obj4(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_simple_pwm_obj5(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
}
...
void create_screen_power_topology_menu() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff2a2a2a), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_power_topology_menu_obj1, LV_EVENT_ALL, 0);
        }
        {
        ...
        }
        {
            ...
            objects.obj4 = obj;
            lv_obj_set_pos(obj, 70, 180);
            lv_obj_set_size(obj, 180, 37);
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_power_topology_menu_obj4, LV_EVENT_ALL, 0);
        }
    }
...
void tick_screen_power_topology_menu() {
    {
        ...
        if (new_val != cur_val) {
            ...
            lv_slider_set_value(objects.obj1, new_val, LV_ANIM_ON);
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = get_var_slider_val();
        int32_t cur_val = lv_spinbox_get_value(objects.obj4);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj4;
            lv_spinbox_set_value(objects.obj4, new_val);
            tick_value_change_obj = NULL;
        }
    }
}
...
void create_screen_simple_pwm() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff2a2a2a), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            objects.obj5 = obj;
            lv_obj_set_pos(obj, 7, 206);
            lv_obj_set_size(obj, 300, 10);
            lv_obj_add_event_cb(obj, event_handler_cb_simple_pwm_obj5, LV_EVENT_ALL, 0);
        }
    }
