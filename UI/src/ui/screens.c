...
static void event_handler_cb_simple_complementary_pwm_simple_complementary_pwm(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        ...
        // group: param_selector
        lv_group_remove_all_objs(groups.param_selector);
        lv_group_add_obj(groups.param_selector, objects.freq_editable_btn_2);
        lv_group_add_obj(groups.param_selector, objects.param_slider_2);
        lv_group_add_obj(groups.param_selector, objects.param_spinbox_2);
...
static void event_handler_cb_simple_complementary_pwm_freq_editable_btn_2(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_simple_complementary_pwm_param_slider_2(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_simple_complementary_pwm_param_spinbox_2(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
static void event_handler_cb_settings_settings(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        ...
        // group: settings_group
        lv_group_remove_all_objs(groups.settings_group);
        lv_group_add_obj(groups.settings_group, objects.param_slider_4);
    }
}

static void event_handler_cb_settings_param_slider_4(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    if (event == LV_EVENT_VALUE_CHANGED) {
        lv_obj_t *ta = lv_event_get_target(e);
        if (tick_value_change_obj != ta) {
...
void create_screen_simple_complementary_pwm() {
    ...
    lv_obj_set_style_bg_color(obj, lv_color_hex(0xff2a2a2a), LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        ...
        }
        {
            ...
            lv_obj_set_style_radius(obj, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    // freq_editable_btn_2
                    lv_obj_t *obj = lv_switch_create(parent_obj);
                    objects.freq_editable_btn_2 = obj;
                    lv_obj_set_pos(obj, 251, 3);
                    lv_obj_set_size(obj, 40, 20);
                    lv_obj_add_event_cb(obj, event_handler_cb_simple_complementary_pwm_freq_editable_btn_2, LV_EVENT_ALL, 0);
                }
                {
                    lv_obj_t *obj = lv_obj_create(parent_obj);
                    lv_obj_set_pos(obj, 4, 20);
                    ...
                    lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            // param_slider_2
                            lv_obj_t *obj = lv_slider_create(parent_obj);
                            objects.param_slider_2 = obj;
                            lv_obj_set_pos(obj, LV_PCT(5), 9);
                            lv_obj_set_size(obj, LV_PCT(90), 12);
                            lv_obj_add_event_cb(obj, event_handler_cb_simple_complementary_pwm_param_slider_2, LV_EVENT_ALL, 0);
                            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_ON_FOCUS|LV_OBJ_FLAG_SCROLL_WITH_ARROW|LV_OBJ_FLAG_SNAPPABLE);
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffa8a8a8), LV_PART_KNOB | LV_STATE_DISABLED);
                            lv_obj_set_style_bg_color(obj, lv_color_hex(0xffa8a8a8), LV_PART_INDICATOR | LV_STATE_DISABLED);
                        }
                ...
                }
                {
                    ...
                    lv_spinbox_set_rollover(obj, false);
                    lv_spinbox_set_step(obj, 1);
                    lv_obj_add_event_cb(obj, event_handler_cb_simple_complementary_pwm_param_spinbox_2, LV_EVENT_ALL, 0);
                    lv_obj_add_flag(obj, LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_text_align(obj, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_font(obj, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
                }
        ...
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            lv_obj_set_pos(obj, LV_PCT(1), 173);
            lv_obj_set_size(obj, LV_PCT(98), 58);
            lv_obj_set_style_pad_left(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_top(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_right(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_bottom(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void tick_screen_simple_complementary_pwm() {
    {
        bool new_val = get_var_simple_pwm_freq_edit_enable_b();
        bool cur_val = lv_obj_has_state(objects.freq_editable_btn_2, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.freq_editable_btn_2;
            if (new_val) lv_obj_add_state(objects.freq_editable_btn_2, LV_STATE_CHECKED);
            else lv_obj_clear_state(objects.freq_editable_btn_2, LV_STATE_CHECKED);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = get_var_simple_pwm_freq_freq_edit_enable_flag_b();
        bool cur_val = lv_obj_has_state(objects.param_slider_2, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.param_slider_2;
            if (new_val) lv_obj_add_state(objects.param_slider_2, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.param_slider_2, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = get_var_pcc_param_freq_val_i32();
        int32_t cur_val = lv_slider_get_value(objects.param_slider_2);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.param_slider_2;
            lv_slider_set_value(objects.param_slider_2, new_val, LV_ANIM_ON);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = get_var_simple_pwm_freq_freq_edit_enable_flag_b();
        bool cur_val = lv_obj_has_state(objects.param_spinbox_2, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.param_spinbox_2;
            if (new_val) lv_obj_add_state(objects.param_spinbox_2, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.param_spinbox_2, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = get_var_pcc_param_freq_val_i32();
        int32_t cur_val = lv_spinbox_get_value(objects.param_spinbox_2);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.param_spinbox_2;
            lv_spinbox_set_value(objects.param_spinbox_2, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        ...
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    // param_slider_4
                    lv_obj_t *obj = lv_slider_create(parent_obj);
                    objects.param_slider_4 = obj;
                    lv_obj_set_pos(obj, LV_PCT(5), 28);
                    lv_obj_set_size(obj, LV_PCT(90), 12);
                    lv_slider_set_range(obj, 10, 100);
                    lv_obj_add_event_cb(obj, event_handler_cb_settings_param_slider_4, LV_EVENT_ALL, 0);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE|LV_OBJ_FLAG_GESTURE_BUBBLE|LV_OBJ_FLAG_PRESS_LOCK|LV_OBJ_FLAG_SCROLL_CHAIN_VER|LV_OBJ_FLAG_SCROLL_ELASTIC|LV_OBJ_FLAG_SCROLL_MOMENTUM|LV_OBJ_FLAG_SCROLL_ON_FOCUS|LV_OBJ_FLAG_SCROLL_WITH_ARROW|LV_OBJ_FLAG_SNAPPABLE);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffa8a8a8), LV_PART_KNOB | LV_STATE_DISABLED);
                    lv_obj_set_style_bg_color(obj, lv_color_hex(0xffa8a8a8), LV_PART_INDICATOR | LV_STATE_DISABLED);
                }
...
void tick_screen_settings() {
    {
        bool new_val = get_var_simple_pwm_freq_freq_edit_enable_flag_b();
        bool cur_val = lv_obj_has_state(objects.param_slider_4, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.param_slider_4;
            if (new_val) lv_obj_add_state(objects.param_slider_4, LV_STATE_DISABLED);
            else lv_obj_clear_state(objects.param_slider_4, LV_STATE_DISABLED);
            tick_value_change_obj = NULL;
        }
    }
    {
        int32_t new_val = get_var_brightness__per_cent__f32();
        int32_t cur_val = lv_slider_get_value(objects.param_slider_4);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.param_slider_4;
            lv_slider_set_value(objects.param_slider_4, new_val, LV_ANIM_ON);
            tick_value_change_obj = NULL;
        }
    }
}
