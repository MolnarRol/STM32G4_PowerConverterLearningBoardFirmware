...
static void PCC_LC_SinglePhaseThyristorVoltageConverter_ActiveHandling_v(void);
...
const PCC_TopologyHandle_struct PCC_Topology_SinglePhaseThyristorVoltageConverter_s =
{
        ...
        .active_handler_pfv = PCC_LC_SinglePhaseThyristorVoltageConverter_ActiveHandling_v,
