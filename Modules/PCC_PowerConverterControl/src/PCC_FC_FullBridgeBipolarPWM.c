...
static void PCC_FC_FullBridgeBipolarPWM_Stop_v(void);
static void PCC_FC_FullBridgeBipolarPWM_DeInit_v(void);

const PCC_TopologyHandle_struct PCC_Topology_FullBridgeBipolarPWM_s =
{
        .initialize_pfv     = PCC_FC_FullBridgeBipolarPWM_Init_v,
        .start_pf           = PCC_FC_FullBridgeBipolarPWM_Start_v,
        .active_handler_pfv = PCC_FC_FullBridgeBipolarPWM_ActiveHandling_v,
        .stop_pfv           = PCC_FC_FullBridgeBipolarPWM_Stop_v,
        .deinitalize_pfv    = PCC_FC_FullBridgeBipolarPWM_DeInit_v,
        .driver_enable_u    =
                            {
                                .drivers_s =
                                {
...
static void PCC_FC_FullBridgeBipolarPWM_Init_v(void)
{
    ...
    TIM1->BDTR                  |= (u32)UTIL_TIM_SetMinumumDeadTimeValue_u8(170.0e6f, PCC_FC_FullBridgeBipolarPWM_DeadTime__s__f32);
}
...
static void PCC_FC_FullBridgeBipolarPWM_ActiveHandling_v(void)
{
    UTIL_TIM_SetTimerOverflowFrequency_v(170.0e6f, 2.0f * PCC_FC_FullBridgeBipolarPWM_freq__Hz__f32, &TIM1->ARR, &TIM1->PSC);
    u32 duty_compare_u32 = (u32)(UTIL_MapFloatToRange_f32(0.0f, (f32)TIM1->ARR, -100.0f, 100.0f, PCC_FC_FullBridgeBipolarPWM_duty__per_cent__f32) + 0.5f);
