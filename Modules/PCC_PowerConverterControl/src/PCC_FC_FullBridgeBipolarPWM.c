...
static void _s_init_v(void)
{
    ...
    SET_BIT(TIM1->CCMR2, TIM_CCMR2_OC3M_2 | TIM_CCMR2_OC3M_1 | TIM_CCMR2_OC3M_0);               /* PWM mode 2. */
...
static void _s_start_v(void)
{
    ...
    u32 duty_compare_u32 = (u32)(UTIL_MapFloatToRange_f32(0.0f, (f32)TIM1->ARR, -100.0f, 100.0f, _SET_DUTY_d) + 0.5f);
