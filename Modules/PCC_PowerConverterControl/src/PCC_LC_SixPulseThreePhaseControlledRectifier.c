/*
 * PCC_LC_SixPulseThreePhaseControlledRectifier.c
 *
...
static void PCC_LC_SixPulseThreePhaseControlledRectifier_InhibitPulses_v(void);
static void PCC_LC_SixPulseThreePhaseControlledRectifier_OperationalHandler_v(void);

const PCC_TopologyHandle_struct PCC_Topology_SixPulseThreePhaseControlledRectifier_s =
{
...
PCC_LC_CommutationParams_s PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s =
{
...
static void PCC_LC_SixPulseThreePhaseControlledRectifier_Init_v(void)
{
    ...
    {
        .start_pulses_pfv       = PCC_LC_SixPulseThreePhaseControlledRectifier_StartPulses_v,
        .inhibit_pulses_pfv     = PCC_LC_SixPulseThreePhaseControlledRectifier_InhibitPulses_v,
        .operation_handler_pfv  = PCC_LC_SixPulseThreePhaseControlledRectifier_OperationalHandler_v
    };
 ...
 *************************************************************************************************/
    ...
    GPIOB->AFR[0]               |= (2UL << GPIO_AFRL_AFSEL0_Pos) |
    ...
    TIM1->CR2                   |= TIM_CR2_MMS_2 | TIM_CR2_MMS_1;          /* Set oc3refc as trigger output. */
    ...
    TIM2->CR2                   |= TIM_CR2_MMS_2 | TIM_CR2_MMS_1;          /* Set oc3refc as trigger output. */
...
static void PCC_LC_SixPulseThreePhaseControlledRectifier_StartPulses_v(void)
{
    PCC_LC_SixPulseThreePhaseControlledRectifier_OperationalHandler_v();
...
static void PCC_LC_SixPulseThreePhaseControlledRectifier_OperationalHandler_v(void)
{
    ...
    TIM1->CCR1 = (u16)UTIL_MapFloatToRange_f32(
                    ...
                    0.0f,
                    360.0f,
                    PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.alpha__deg__f32);
    ...
    TIM1->CCR2 = (u16)UTIL_MapFloatToRange_f32(
                    ...
                    0.0f,
                    360.0f,
                    PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.alpha__deg__f32 + PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.pulse_len__deg__f32);
    ...
    TIM1->CCR3 = (u16)UTIL_MapFloatToRange_f32(
                    ...
                    0.0f,
                    360.0f,
                    PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.alpha__deg__f32 + 60.0f);
    ...
    TIM1->CCR4 = (u16)UTIL_MapFloatToRange_f32(
                    ...
                    0.0f,
                    360.0f,
                    PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.alpha__deg__f32 + 60.0f + PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.pulse_len__deg__f32);
    ...
    TIM2->CCR2 = (u16)UTIL_MapFloatToRange_f32(
                    ...
                    0.0f,
                    360.0f,
                    60.0f + PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.pulse_len__deg__f32);

    TIM2->CCR3 = (u16)UTIL_MapFloatToRange_f32(
                    0.0f,
                    (f32)TIM1->ARR,
                    0.0f,
                    360.0f,
    ...
    TIM2->CCR4 = (u16)UTIL_MapFloatToRange_f32(
                    0.0f,
                    (f32)TIM1->ARR,
                    0.0f,
                    360.0f,
                    120.0f + PCC_LC_SixPulseThreePhaseControlledRectifier_ActualParams_s.pulse_len__deg__f32);
