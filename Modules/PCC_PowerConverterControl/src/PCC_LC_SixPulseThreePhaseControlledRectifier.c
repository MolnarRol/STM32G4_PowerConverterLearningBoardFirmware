...
const PCC_TopologyHandle_struct PCC_Topology_SixPulseThreePhaseControlledRectifier_s =
{
    ...
    .ctrl_name_str      = "6 impulse controlled rectifier\0"
};
...
static void _s_init_v(void)
{
    ...
    SET_BIT(TIM1->CR2, TIM_CR2_MMS_2 | TIM_CR2_MMS_1);                      /* Set oc3refc as trigger output. */
    ...
    SET_BIT(TIM2->CR2, TIM_CR2_MMS_2 | TIM_CR2_MMS_1);                      /* Set oc3refc as trigger output. */
...
static void _s_start_pulses_v(void)
{
    ...
    SET_BIT(TIM2->CCMR2,TIM_CCMR2_OC3PE | TIM_CCMR2_OC4PE);
    SET_BIT(TIM3->CCMR1,TIM_CCMR1_OC1PE | TIM_CCMR1_OC2PE);
    SET_BIT(TIM3->CCMR2,TIM_CCMR2_OC3PE | TIM_CCMR2_OC4PE);
...
static void _s_inhibit_pulses_v(void)
{
    ...
    CLEAR_BIT(TIM1->CCMR2,TIM_CCMR2_OC3PE | TIM_CCMR2_OC4PE);
    CLEAR_BIT(TIM2->CCMR1,TIM_CCMR1_OC1PE | TIM_CCMR1_OC2PE);
    CLEAR_BIT(TIM2->CCMR2,TIM_CCMR2_OC3PE | TIM_CCMR2_OC4PE);
    CLEAR_BIT(TIM3->CCMR1,TIM_CCMR1_OC1PE | TIM_CCMR1_OC2PE);
    CLEAR_BIT(TIM3->CCMR2,TIM_CCMR2_OC3PE | TIM_CCMR2_OC4PE);
}
...
static void _s_operational_handler_v(void)
{
    ...
    TIM1->CCR4 = (u16)UTIL_MapFloatToRange_f32(
                    ...
                    0.0f,
                    360.0f,
                    _SET_ALPHA_d + _SET_PULSE_LEN_d + 60.0f);
