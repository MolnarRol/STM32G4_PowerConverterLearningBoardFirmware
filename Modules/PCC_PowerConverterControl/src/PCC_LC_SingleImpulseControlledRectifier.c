...
static void pCC_LC_SingleImpulseControlledRectifier_Start_v(void);
static void pCC_LC_SingleImpulseControlledRectifier_ActiveHandling_v(void);
static void pCC_LC_SingleImpulseControlledRectifier_Stop_v(void);
static void pCC_LC_SingleImpulseControlledRectifier_DeInit_v(void);

const PCC_TopologyHandle_struct PCC_Topology_FullBridgeBipolarPWM_s =
{
        .initialize_pfv     = pCC_LC_SingleImpulseControlledRectifier_Init_v,
        .start_pf           = pCC_LC_SingleImpulseControlledRectifier_Start_v,
        .active_handler_pfv = pCC_LC_SingleImpulseControlledRectifier_ActiveHandling_v,
        .stop_pfv           = pCC_LC_SingleImpulseControlledRectifier_Stop_v,
...
volatile f32 pCC_LC_SingleImpulseControlledRectifier_freq__Hz__f32 = 10000.0f;
volatile f32 pCC_LC_SingleImpulseControlledRectifier_duty__per_cent__f32 = 0.0f;
volatile f32 pCC_LC_SingleImpulseControlledRectifier_DeadTime__s__f32 = 75.0e-9f;
...
static void pCC_LC_SingleImpulseControlledRectifier_Init_v(void)
{
    ...
    TIM1->CCMR2                 |= TIM_CCMR2_OC3M_2 |
                                   TIM_CCMR2_OC3M_1 |
                                   TIM_CCMR2_OC3M_0 |                       /* PWM mode 2. */
                                   TIM_CCMR2_OC3PE;

    /* Dead time configuration. */
    TIM1->BDTR                  &= ~TIM_BDTR_DTG_Msk;
    TIM1->BDTR                  |= (u32)UTIL_TIM_SetMinumumDeadTimeValue_u8(170.0e6f, pCC_LC_SingleImpulseControlledRectifier_DeadTime__s__f32);
}
...
static void pCC_LC_SingleImpulseControlledRectifier_ActiveHandling_v(void)
{
    UTIL_TIM_SetTimerOverflowFrequency_v(170.0e6f, 2.0f * pCC_LC_SingleImpulseControlledRectifier_freq__Hz__f32, &TIM1->ARR, &TIM1->PSC);
    u32 duty_compare_u32 = (u32)(UTIL_MapFloatToRange_f32(0.0f, (f32)TIM1->ARR, -100.0f, 100.0f, pCC_LC_SingleImpulseControlledRectifier_duty__per_cent__f32) + 0.5f);

    TIM1->CCR1                  = duty_compare_u32;
    TIM1->CCR3                  = duty_compare_u32;
