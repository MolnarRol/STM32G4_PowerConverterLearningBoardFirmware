...
static void PCC_FC_ThreePhaseScalar_Init_v(void);
static void PCC_FC_ThreePhaseScalar_Start_v(void);
static void PCC_FC_ThreePhaseScalar_ActiveHandling_v(void);
...
const PCC_TopologyHandle_struct PCC_Topology_ThreePhaseScalar_s =
{
        ...
        .start_pf           = PCC_FC_ThreePhaseScalar_Start_v,
        .active_handler_pfv = PCC_FC_ThreePhaseScalar_ActiveHandling_v,
        .stop_pfv           = PCC_FC_ThreePhaseScalar_Stop_v,
        .deinitalize_pfv    = PCC_FC_SimpleThreePhaseScalar_DeInit_v,
        .driver_enable_u    =
                            {
                                .drivers_s =
                                {
